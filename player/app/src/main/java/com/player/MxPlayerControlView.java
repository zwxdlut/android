 ...
 *
 * <p>A MyPlayerControlView can be customized by setting attributes (or calling corresponding
 * methods), overriding drawables, overriding the view's layout file, or by specifying a custom view
 * layout file.
 *
 * <h3>Attributes</h3>
 *
 * The following attributes can be set on a MyPlayerControlView when used in a layout XML file:
 *
 * <ul>
 ...
 *         <li>Default: {@link com.google.android.exoplayer2.ui.MyPlayerControlView#DEFAULT_REPEAT_TOGGLE_MODES}
 *       </ul>
 ...
 *       MyPlayerControlView, and will be propagated to the inflated {@link DefaultTimeBar} unless the
 *       layout is overridden to specify a custom {@code exo_progress} (see below).
 * </ul>
 *
 * <h3>Overriding drawables</h3>
 *
 * The drawables used by MyPlayerControlView (with its default layout file) can be overridden by
 ...
 *
 * To customize the layout of MyPlayerControlView throughout your app, or just for certain
 * configurations, you can define {@code exo_player_control_view.xml} layout files in your
 * application {@code res/layout*} directories. These layouts will override the one provided by the
 * ExoPlayer library, and will be inflated for use by MyPlayerControlView. The view identifies and
 ...
 *         <li>Note: MyPlayerControlView will programmatically set the drawable on the repeat toggle
 ...
 *       <ul>
 *         <li>Type: {@link ImageView}
 *         <li>Note: MyPlayerControlView will programmatically set the drawable on the shuffle button
 ...
 *       {@link DefaultTimeBar} attributes set on the MyPlayerControlView will not be automatically
 ...
 * MyPlayerControlView throughout your application. It's also possible to customize the layout for a
 * single instance in a layout file. This is achieved by setting the {@code controller_layout_id}
 * attribute on a MyPlayerControlView. This will cause the specified layout to be inflated instead of
 * {@code exo_player_control_view.xml} for only the instance on which the attribute is set.
 */
public class MxPlayerControlView extends FrameLayout {
    ...
    public interface DisplayModeListener {
         ...
         *
         * @param mode The display mode changed to.
         * <ul>
         * <li>{@link DisplayMode#NORMAL}
         * <li>{@link DisplayMode#FULL_SCREEN}
         * <ul/>
         */
    ...
    private final MxPlayerControlView.ComponentListener componentListener;
    private final CopyOnWriteArrayList<MxPlayerControlView.VisibilityListener> visibilityListeners;
    ...
    @Nullable private final View fullScreenButton;
    ...
    @Nullable private MxPlayerControlView.ProgressUpdateListener progressUpdateListener;
    ...
    private DisplayModeListener displayModeListener = null;

    public MxPlayerControlView(Context context) {
        this(context, /* attrs= */ null);
    }

    public MxPlayerControlView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, /* defStyleAttr= */ 0);
    }

    public MxPlayerControlView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public MxPlayerControlView(
        ...
        componentListener = new MxPlayerControlView.ComponentListener();
        ...
        fullScreenButton = findViewById(R.id.iv_full_screen);
    ...
    /**
     * Adds a {@link MxPlayerControlView.VisibilityListener}.
     *
     * @param listener The listener to be notified about visibility changes.
     */
    public void addVisibilityListener(MxPlayerControlView.VisibilityListener listener) {
        visibilityListeners.add(listener);
    }

    /**
     * Removes a {@link MxPlayerControlView.VisibilityListener}.
     *
     * @param listener The listener to be removed.
     */
    public void removeVisibilityListener(MxPlayerControlView.VisibilityListener listener) {
        visibilityListeners.remove(listener);
    }

    /**
     * Sets the {@link MxPlayerControlView.ProgressUpdateListener}.
     *
     * @param listener The listener to be notified about when progress is updated.
     */
    public void setProgressUpdateListener(@Nullable MxPlayerControlView.ProgressUpdateListener listener) {
    ...
    public void show() {
        if (!isVisible()) {
            ...
            for (MxPlayerControlView.VisibilityListener visibilityListener : visibilityListeners) {
    ...
    private final class ComponentListener
        ...
        public void onClick(View view) {
            Player player = MxPlayerControlView.this.player;
            if (player == null) {
                return;
            }
            if (nextButton == view) {
    ...
    public void setDisplayModeListener(DisplayModeListener listener) {
        displayModeListener = listener;
    }

    private void changeDisplayMode() {
        if (DisplayMode.NORMAL == displayMode) {
            displayMode = DisplayMode.FULL_SCREEN;
            fullScreenButton.setActivated(true);
        } else if (DisplayMode.FULL_SCREEN == displayMode) {
