...
import com.voice.recognizer.asr5.AsrAssetExtractor;
import com.voice.recognizer.asr5.AsrComponentsInitializer;
import com.voice.recognizer.asr5.AsrConfigParam;
import com.voice.recognizer.asr5.AsrEventHandler;
import com.voice.recognizer.asr5.AsrResult;
import com.voice.recognizer.asr5.IAsrAssetExtractor;
import com.voice.recognizer.asr5.IAsrComponentsInitializer;
import com.voice.recognizer.asr5.IAsrConfigParam;
import com.voice.recognizer.asr5.IAsrEventHandler;
import com.voice.recognizer.asr5.IAsrResult;
import com.voice.recognizer.asr5.SampleRecognizerListener;
import com.voice.recognizer.custom_audio.audioIn;
import com.voice.recognizer.vad.VadApi;
...
public class VoiceRecognizer {
    ...
    static {
        System.loadLibrary("vad_api_native");
    }
    ...
    public static VoiceRecognizer getInstance(Context context) {
        if (null == instance) {
            synchronized (VoiceRecognizer.class) {
                if (null == instance) {
                    instance = new VoiceRecognizer(context);
                }
            }
        }
