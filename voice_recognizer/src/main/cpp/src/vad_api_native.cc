...
JNIEXPORT jint JNICALL Java_com_voice_recognizer_vad_VadApi_create(JNIEnv *_env, jobject _thiz, jstring _res_path)
{
    int ret = 0;
...
JNIEXPORT jint JNICALL Java_com_voice_recognizer_vad_VadApi_delete(JNIEnv *_env, jobject _thiz)
{
    if (NULL == g_engine)
    {
        return 0;
...
JNIEXPORT jint JNICALL Java_com_voice_recognizer_vad_VadApi_start(JNIEnv *_env, jobject _thiz, jobject _callback)
{
    if (NULL == g_engine)
    {
        return -1;
...
JNIEXPORT jint JNICALL Java_com_voice_recognizer_vad_VadApi_stop(JNIEnv *_env, jobject _thiz)
{
    if (NULL == g_engine)
    {
        return -1;
...
JNIEXPORT jint JNICALL Java_com_voice_recognizer_vad_VadApi_reset(JNIEnv *env, jobject thiz)
{
    if (NULL == g_engine)
    {
        return -1;
...
JNIEXPORT jint JNICALL Java_com_voice_recognizer_vad_VadApi_feed(JNIEnv *_env, jobject _thiz, jbyteArray _buf, jint _size)
{
    if (NULL == g_engine)
    {
        return -1;
...
JNIEXPORT jint JNICALL Java_com_voice_recognizer_vad_VadApi_setting(JNIEnv *_env, jobject _thiz, jstring _config)
{
    int ret = 0;
